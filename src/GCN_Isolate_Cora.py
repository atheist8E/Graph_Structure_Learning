...
def set_args():
	...
	parser.add_argument("--model",              type = str,        default = "GCN_Isolate")
	parser.add_argument("--description",        type = str,        default = "GCN Self Loop")
...
if __name__ == "__main__":
	...
	with open(os.path.join(args.result_path, "Experiment_Description.txt"), "w") as f:
		...
		dataset = Planetoid(root = os.path.join(args.source_path, args.dataset + "_Isolate"), name = "Cora", pre_transform = Compose([Isolate()]))
