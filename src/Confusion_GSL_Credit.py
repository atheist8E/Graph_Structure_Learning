...
def set_args():
    ...
    parser.add_argument("--model",              type = str,        default = "Confusion_GSL_Credit")
    parser.add_argument("--description",        type = str,        default = "Confusion GSL on Credit")
...
if __name__ == "__main__":
    ...
    with open(os.path.join(args.result_path, "Experiment_Description.txt"), "w") as f:
        ...
        dataset = Credit_Graph_Dataset(args = args, root = os.path.join(args.source_path, args.dataset), train_fname = "trainfeat_all.pkl", test_fname = "testfeat_all.pkl")
